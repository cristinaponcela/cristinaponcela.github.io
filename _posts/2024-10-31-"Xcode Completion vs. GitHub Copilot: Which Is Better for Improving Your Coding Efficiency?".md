...
![Desktop View](/assets/img/XcodeCompletion.mov){: width="280vw" height="420vw" }
...
![Desktop View](/assets/img/CopilotWorks.mov){: width="280vw" height="420vw" }
...
![Desktop View](/assets/img/CodeSnippets.png){: width="280vw" height="420vw" }

And now onto my actual favorite feature… ChatGPT integrated in my IDE! Truly a dream come true.

![Desktop View](/assets/img/CopilotChatGPT.png){: width="280vw" height="420vw" }
