...
![Desktop View](/assets/img/HabitTracker/DailyView.png){: width="280vw" height="520vw" }{: .left}

![Desktop View](/assets/img/HabitTracker/WeeklyView.png){: width="280vw" height="520vw" }{: .normal}

![Desktop View](/assets/img/HabitTracker/MonthlyView.png){: width="280vw" height="520vw" }{: .right}

![Desktop View](/assets/img/HabitTracker/AddFriend.png){: width="280vw" height="520vw" }{: .left}

![Desktop View](/assets/img/HabitTracker/ScheduledCall.png){: width="280vw" height="520vw" }{: .right}
