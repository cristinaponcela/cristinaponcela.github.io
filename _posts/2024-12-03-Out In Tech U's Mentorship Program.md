...
![Desktop View](/assets/img/HabitTracker/DailyView.png){: width="240vw" height="430vw" }{: .normal}

![Desktop View](/assets/img/HabitTracker/WeeklyView.png){: width="240vw" height="430vw" }{: .normal}

![Desktop View](/assets/img/HabitTracker/MonthlyView.png){: width="240vw" height="430vw" }{: .normal}

<div style="clear: both;"></div>

![Desktop View](/assets/img/HabitTracker/AddFriend.png){: width="280vw" height="500vw" }{: .normal}

![Desktop View](/assets/img/HabitTracker/ScheduledCall.png){: width="280vw" height="500vw" }{: .right}
