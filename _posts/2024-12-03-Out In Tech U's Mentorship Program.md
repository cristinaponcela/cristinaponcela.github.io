...
![Desktop View](/assets/img/HabitTracker/DailyView.png){: width="220vw" height="400vw" }{: .left}

![Desktop View](/assets/img/HabitTracker/WeeklyView.png){: width="220vw" height="400vw" }{: .normal}

![Desktop View](/assets/img/HabitTracker/MonthlyView.png){: width="220vw" height="400vw" }{: .normal}

<div style="clear: both;"></div>

![Desktop View](/assets/img/HabitTracker/AddFriend.png){: width="260vw" height="470vw" }{: .left}

![Desktop View](/assets/img/HabitTracker/ScheduledCall.png){: width="260vw" height="470vw" }{: .right}
